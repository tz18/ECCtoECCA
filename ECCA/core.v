...
(APP: APPt) (PAI: PAIt) (IFF: IFFt) (FST: FSTt) (SND: SNDt).
...
Lemma ctx_has (g: env) (x: name) (a: ctxmem):
  (has (ctx_cons g x a) (free x) (apply (^x)%ren a)).
Proof.
  unfold has. names. auto.
Qed.
