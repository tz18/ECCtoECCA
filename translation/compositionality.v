...
1,2,12,13,14: simp translate; rewrite cont_compose_fill_het_compose; auto; exact "k".
  ...
  + simp translate; rewrite cont_compose_fill_het_compose; auto; try exact "k"; constructor. constructor. apply translate_makes_ANF. cbn; auto.
    apply close_ANF_iff. apply translate_makes_ANF. cbn; auto.
  + simp translate. rewrite H0. names. rewrite H. names. rewrite cont_compose_fill_het_compose. rewrite shift_over_conts. rewrite shift_over_conts. auto.
    all: auto.     
    - exact "k".
  ...
  + simp translate. rewrite H0. names. rewrite H. cbn. rewrite shift_over_conts. auto.
    all: cbn; auto.
    - apply close_ANF_iff. apply translate_makes_ANF. auto.
  + simp translate; rewrite cont_compose_fill_het_compose; auto; try exact "k"; constructor. constructor. apply translate_makes_ANF. cbn; auto.
    apply close_ANF_iff. apply translate_makes_ANF. cbn; auto.
  + simp translate. rewrite H1. names. rewrite H0. names. rewrite cont_compose_fill_het_compose. rewrite shift_over_conts. rewrite shift_over_conts. auto.
     all: auto.
     - exact "k".
  ...
  + simp translate. rewrite H. names. rewrite cont_compose_fill_het_compose. rewrite shift_over_conts. auto.
    exact "k". apply Fst. all: auto. cbn. apply close_ANF_iff. auto.
  + simp translate. rewrite H. names. rewrite cont_compose_fill_het_compose. rewrite shift_over_conts. auto.
    exact "k". apply Snd. all: auto. cbn. apply close_ANF_iff. auto.
  + simp translate. names. rewrite H1. cbn. names. rewrite het_compose_equation. rewrite H0. names. rewrite H. names. rewrite shift_over_conts. auto.
